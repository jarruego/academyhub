...
Cliente y estructura + Acciones formativas ("usar un curso ya existente") + Plan base y por centro + Consultoría anual (manual, por cliente con centros participantes) + Evaluación de acciones formativas + Cuadro de formación por centro implementados (2026-09-15/16). El resto del módulo (dar de alta una acción nueva, competencias, acceso externo por token, y el automatismo de apertura/cierre) sigue sin construir — se añadirá aquí a la vez que cada pieza.
