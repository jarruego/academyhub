...
| Plan de formación (`consulting_plan_items`): listar / añadir / quitar (base y por centro) | ✅ | ❌ | ❌ | ❌ | ✅ | Mismo `ConsultingClientController`, `[ADMIN, CONSULTOR]` — solo admite acciones ya etiquetadas (`consulting_action_details`) |
