...
import { moodleUserAuthUserTable } from "./schema/tables/moodle_user_auth_user.table";
...
import { smsSettingsTable } from "./schema/tables/sms_settings.table";
import { smsTemplatesTable } from "./schema/tables/sms_templates.table";
import { smsLogTable } from "./schema/tables/sms_log.table";
...
export const moodle_user_auth_user = moodleUserAuthUserTable;
...
export const sms_settings = smsSettingsTable;
export const sms_templates = smsTemplatesTable;
export const sms_log = smsLogTable;
