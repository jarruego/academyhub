...
export const userTable = pgTable("users", {
    ...
    job_position: text("job_position").default(null),
    contribution_group_code: integer("contribution_group_code"),
    professional_category: text("professional_category").default(null),
